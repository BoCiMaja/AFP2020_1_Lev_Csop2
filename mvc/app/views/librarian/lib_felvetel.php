        <article>
            <form method="POST" action="<?=BASEURL?>/librarian/register">
                <div class="container">          
                    <div class="column">
                            ...
                            <input type="checkbox" id="admin" name="admin" tabindex="17">
                    ...
                    <input type="submit" name="submit" value="Könyvtáros felvétele nyilvántartásba" tabindex="19">
                </div>
            </form>			
        </article>
    </body>
